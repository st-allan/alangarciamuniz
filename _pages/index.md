...
<main class="mw7 center">
  <ul class="list pl0">
    {% for note in site.notes | sort: 'date' | slice: 0, 5 %}
    <li class="pa3 pa4-ns mb3">
      ...
      <h2 class="f4 f3-ns dim dark-gray"><a href="{{ note.url }}">{{ note.title }}</a></h2>
      <p class="measure-wide lh-copy f6 dark-gray tj-ns">{{ note.description | truncatewords: 25, "..." }}</p>
